...
stays observable independently of the decorator, the after_request
hook, and the 429 exception. The custom-policy assertion fixes the
...
class TestInjectRateLimitHeadersCustomPolicy:
    ...
    defaults on both the success and the error paths.
    """
